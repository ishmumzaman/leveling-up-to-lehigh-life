...
export class TimedEvent {
   ...
   * loop.
   *
   * @param elapsed How many more seconds have transpired.  Can be negative to
   *                delay when the next timer event happens.
   */
  public add(elapsed: number) { this.msUntilNext -= (1000 * elapsed); }
}
...
export class TimerService {
  ...
  // [mfs]  I'm not sure we actually need this.  Events should capture a bool to
  //        toggle if they need to be disabled.
  public removeEvent(event: TimedEvent) {
