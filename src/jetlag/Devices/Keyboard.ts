...
export enum KeyCodes {
  ...
  KEY_CAPSLOCK = 'CapsLock', KEY_A = 'KeyA', KEY_S = 'KeyS', KEY_D = 'KeyD',
  KEY_F = 'KeyF', KEY_G = 'KeyG', KEY_H = 'KeyH', KEY_J = 'KeyJ', KEY_K = 'KeyK',
  KEY_L = 'KeyL', KEY_SEMICOLON = 'Semicolon', KEY_QUOTE = 'Quote',
  KEY_ENTER = 'Enter',
