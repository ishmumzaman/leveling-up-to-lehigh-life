...
class FilterableContainerSet {
  /** Nine container/filter pairs, for the nine Z planes */
  private zContainers: [FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer, FilterableContainer];

  /** One more container/filter pair, that can hold the nine Z containers */
  ...
  constructor() {
    ...
    this.zContainers = [new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer(), new FilterableContainer()];
  }
  ...
  public addChild(graphic: Graphics | PixiSprite | PixiText, z: ZIndex) {
    this.zContainers[z + 4].container.addChild(graphic);
  }
  ...
  public addZFilter(filter: FilterComponent, z: ZIndex) {
    this.zContainers[z + 4].filters.push(filter);
  }
