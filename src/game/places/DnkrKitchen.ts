...
import * as hall_objects from "../../../tilemaps/TileMaps/DnkrKitchen.json"
 ...
 */
export const DnkrKitchenBuilder: Builder = function (level: number) {
  ...
  sStore.currQuest?.onBuildPlace(Places.DNKR_KITCHEN, level);
...
DnkrKitchenBuilder.builderName = "DnkrKitchen";
DnkrKitchenBuilder.playerLimit = 15