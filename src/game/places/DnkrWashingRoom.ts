...
import * as hall_objects from "../../../tilemaps/TileMaps/DnkrWashingRoom.json"
 ...
 */
export const DnkrWashingRoomBuilder: Builder = function (level: number) {
  ...
  sStore.currQuest?.onBuildPlace(Places.DNKR_WASHING_ROOM, level);
...
DnkrWashingRoomBuilder.builderName = "DnkrWashingRoom";
DnkrWashingRoomBuilder.playerLimit = 15