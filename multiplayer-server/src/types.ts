...
export class Room {
   ...
   *
   * @param builder The room's builder (Name of the builder function)
   * @param id The room's id (Randomly generated string)
   */
  constructor(public builder: string, public id: string) { }
}
...
export class OutfitChange {
  /** A string representation of the message type */
  static TAG = "OutfitChange"
  /**
   * Construct a OutfitChange message
   *
   * @param userId   The Id of the user who changed outfit
   * @param userName The name of the user who changed outfit
   * @param msg      The message to send (typically serialized JSON)
   */
  constructor(public userId: string, public userName: string, public msg: string) { }
}
...
export class Move {
  ...
  static TAG = "Move"
  /**
   * Construct a Move message
   *
   * @param userId   The Id of the user who is moving
   * @param userName The name of the user who is moving
   * @param msg      The message to send (typically serialized JSON)
   */
  constructor(public userId: string, public userName: string, public msg: string) { }
}
...
export class ResCreated {
   ...
   *
   * @param roomInfo The info of the room that was just created
   */
  constructor(public roomInfo: {builder: string, id: string}) { }
}
...
export class ResJoined {
   ...
   *
   * @param roomInfo The info of the room that was joined (builder and ID)
   * @param peers  A collection of users who are in the room already
   */
  constructor(public roomInfo: {builder: string, id: string}, public peers: { id: string, name: string }[]) { };
}

/** A message sent to a client who switched to an existing room */
export class ResSwitched {
  /** A string representation of the message type */
  static TAG = "ResSwitched"
  /**
   * Construct a ResSwitched message
   *
   * @param msg Some kind of message, usually ""
   */
  constructor(public msg: string) { };
}

/** A message sent to a client who left a room */
export class ResLeft {
  /** A string representation of the message type */
  static TAG = "ResLeft"

  /**
   * Construct a ResLeft message
   * 
   * @param msg Some kind of message, usually ""
   */
  constructor(public msg: string) { }
...
export class ReqJoin {
   ...
   * Construct a ReqJoin message
   *
   * @param roomId The info of the room to join.  It's string|undefined to
   *               facilitate checking for malformed requests
   */
  constructor(public roomInfo: {builder: string | undefined, id: string | undefined} | undefined) { }
}

/** A message sent by a client trying to leave a room */
...
export class ReqSwitch{
  /** A string representation of the message type */
  static TAG = "ReqSwitch"
  /** Construct a ReqJoin message */
  constructor(public builderInfo: string) {}
}
 ...
 */
export type Message = EvtUserJoined | EvtUserLeft | Broadcast | OutfitChange | Move | ResErrHasUser | ResErrNoRoom | ResErrUserTaken | ResErrHasRoom | ResErrNoRoom | ResErrFormat | ResLoggedIn | ResLoggedOut | ResSent | ResCreated | ResJoined | ResSwitched | ResLeft | ReqLoginToken | ReqCreate | ReqJoin | ReqLeave | ReqSwitch | ReqLogout;
